 ...
 */
final class Version20180918123514 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE persona (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nome VARCHAR(255) NOT NULL, cognome VARCHAR(255) NOT NULL, codice_fiscale VARCHAR(255) NOT NULL, codice_cri VARCHAR(255) NOT NULL, altro VARCHAR(1024) DEFAULT NULL, lista_qualifiche CLOB DEFAULT NULL --(DC2Type:json)
        )');
        ...
        $this->addSql('CREATE TABLE equipaggio (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_mezzo INTEGER NOT NULL, numero_turno INTEGER NOT NULL, note VARCHAR(1024) DEFAULT NULL, id_persona_abctlista CLOB NOT NULL --(DC2Type:json)
        , inizio DATETIME DEFAULT NULL, fine DATETIME DEFAULT NULL)');
    }
